...
def simulate_game_VI(game_,MOVES_,dict_board0,dict_piece_loc0,board_rows_,pieces_,board_cols_):
...
#             print(source_,source_2,destination_)
            ...
            if points_on_board[0]<13 and points_on_board[1]<13 and flag_==0:
                flag_=1
...
#             print(move_,'Castling Move')
    ...
    return Lifetimes_,dict_board, dict_piece_loc,dict_pieces_endgame,endgame_reached,move_on_which_endgame_reached,points_on_board_endgame, points_on_board,first_promotion_move, points_after_endgame_w,    points_after_endgame_b,    takes_after_endgame,    it_move_after_endgame
